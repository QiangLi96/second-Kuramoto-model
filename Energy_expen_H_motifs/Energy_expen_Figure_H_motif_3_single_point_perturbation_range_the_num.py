...
H_simulation_range = np.load("Energy_expen_H_motif_3_single_point_numerical_perturbation_range_nonlinear.npy")
H_analytic_range = np.load("Energy_expen_H_motif_3_single_point_theoretical_perturbation_range.npy")
...
for i in range(0,2):
    ...
    plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_3_'+str(i)+'_perturbation_range_omega_theta.pdf')
    #plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_3_perturbation_range_omega_theta.eps',format='eps',dpi=1000)
    #plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_3_perturbation_range_omega_theta.png')
    #plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_3_perturbation_range_omega_theta.eps',format='eps',dpi=1000)
    #plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_3_perturbation_range_omega_theta.png')
plt.show()
...
H_simulation = np.load("E_ex_H_motif_3_random_imshow_nonlinear_simulation.npy")
...
plt.yticks(fontsize=14)
plt.colorbar()
plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_3_c_perturbation_range_omega_theta.pdf')

plt.figure(4)
im_motif3 = plt.imread("F:\Latex_work\work_2_2019_5_22\Figures\motif_3_2.png")
plt.imshow(im_motif3)
plt.axis('off')
plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_3_d_perturbation_range_omega_theta.pdf')
#plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_3_perturbation_range_omega_theta.png')
plt.show()
#plot error bar
