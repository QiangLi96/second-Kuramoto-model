...
H_simulation_range = np.load("Energy_expen_H_motif_1_single_point_numerical_perturbation_range_nonlinear.npy")
H_analytic_range = np.load("Energy_expen_H_motif_1_single_point_theoretical_perturbation_range.npy")
...
for i in range(0,2):
    ...
    plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures_2\Fig_H1_Energy_expen_motif_1_'+str(i)+'_perturbation_range_omega_theta.pdf')
#plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_1_perturbation_range_omega_theta.pdf')
#plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_1_perturbation_range_omega_theta.png')
...
H_simulation = np.load("E_ex_H_motif_1_random_imshow_nonlinear_simulation.npy")
...
plt.xlabel(r'$\delta\omega_1$',fontsize=14)
plt.ylabel(r'$\delta\theta_1$',fontsize=14)
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
plt.colorbar()
plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures_2\Fig_H1_Energy_expen_motif_1_c_perturbation_range_omega_theta.pdf')
plt.show()


plt.figure(4)
im_motif1 = plt.imread("F:\Latex_work\work_2_2019_5_22\Figures_2\motif_1_2.png")
plt.imshow(im_motif1)
plt.axis('off')
plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures_2\Fig_H1_Energy_expen_motif_1_d_perturbation_range_omega_theta.pdf')
#plt.savefig('F:\Latex_work\work_2_2019_5_22\Figures\Fig_H1_Energy_expen_motif_1_perturbation_range_omega_theta.png')
plt.show()
