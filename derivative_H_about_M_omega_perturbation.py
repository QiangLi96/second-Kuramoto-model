...
print H_derivative
np.save("Energy_expended_H_derivative_M_omega_perturbation_S_is_M.npy",H_derivative)
#np.save("Energy_expended_H_derivative_M_omega_perturbation.npy",H_derivative)
time_terminal = time.time()
print('totally cost', str("{:.2f}".format(time_terminal - time_start)) + "s")

plt.plot(M_range,H_derivative,'o-',color='red',label='omega_perturbation',alpha=0.5)
